...
const AdminLoanApplication = () => {
    ...
    return (
        <div className="adminloanapplication">
            <h2>Admin Loan Applications</h2>
            {error && <p className="adminloanapplication-error">{error}</p>}
            {loanApplications.length > 0 ? (
                <table className="adminloanapplication-table">
                    <thead>
                        <tr>
                            <th>ID</th>
                            <th>Aadhar Number</th>
                            ...
                            <tr key={loan.id}>
                                ...
                                <td>
                                    <select
                                        ...
                                        className="adminloanapplication-select"
                                    >
            ...
            <button onClick={handleBack} className="adminloanapplication-back-button">Back</button>
        </div>
    );
};
